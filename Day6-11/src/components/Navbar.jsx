...
const searchHandler = () => {
  searchRef.current.classList.toggle("active"); // Toggles search form visibility
  inputRef.current.focus();
  toggleCart(false); // <--- This explicitly closes the cart dropdown
 ...
 const handleCartIconClick = () => {
  ...
  searchRef.current.classList.remove("active"); // <--- This closes the search form
  setMenuOpen(false); // This closes the mobile menu
};
